		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				for (int i = 0; i < firstArray.length(); i++) {
					...
					View mLinearView = (View) ((LayoutInflater) getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.row_layout, null);
...
//							 }
					...
					if(level1_categorymap.get(i).equals(level1_cur_value))
					{
						...
						for (int j = 0; j < secondArray.length(); j++) {
							...
							View mLinearView2 = (View) ((LayoutInflater) getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.row_layout, null);
...
//									level1_cur_value=level1_select_cid;
							...
							if(level2_categorymap.get(j).equals(level2_cur_value))
							{
								...
								for (int k = 0; k < thirdArray.length(); k++) {
									...
									View mLinearView3 = (View) ((LayoutInflater) getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.row_layout, null);
